...
public class FROnly extends EagerEncodingHeuristic{

    private final List<Relation> allRelations;
    private int strength;
    private int startIteration;

    public FROnly(VerificationTask task, int startIteration, int strength) {
        super(task);
